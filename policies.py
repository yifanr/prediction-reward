...
class ActorCriticPolicy(BasePolicy):
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        actions_onehot = action_to_onehot(actions, self.action_space)

        # print(actions, th.nn.functional.one_hot(actions, self.action_space.n))
        # Predict
    ...
    def evaluate_actions(self, obs: th.Tensor, actions: th.Tensor, next_obs: th.Tensor, episode_ends: th.Tensor
